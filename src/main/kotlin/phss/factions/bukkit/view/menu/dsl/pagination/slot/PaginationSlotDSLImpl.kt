package phss.factions.bukkit.view.menu.dsl.pagination.slot

import phss.factions.bukkit.view.menu.dsl.pagination.MenuPaginationImpl
...
class PaginationSlotDSLImpl<T>(
    ...
    override val paginationEventHandler =
        PaginationSlotEventHandler<T>()
