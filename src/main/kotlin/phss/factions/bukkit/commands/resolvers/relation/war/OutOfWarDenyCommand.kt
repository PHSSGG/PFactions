...
class OutOfWarDenyCommand(
    ...
    override fun invoke(sender: CommandSender, args: Array<out String>) {
        ...
        if (request == null) {
            sender.sendMessage(messages.getMessage("outofwarNotInvited"))
            return
        }
        ...
        sender.sendMessage(messages.getMessage("outofwarInviteDeny").replaceFactionInfo(targetFaction, plugin))
    }
